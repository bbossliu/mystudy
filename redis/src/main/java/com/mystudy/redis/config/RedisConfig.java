...
//        jedisPoolConfig.setTestWhileIdle(true);  //是否开启空闲资源监测
    ...
    public Redisson redisson(){
        ...
        config.useSingleServer().setAddress("redis://192.168.2.129:6379").setDatabase(0);
//        config.useClusterServers().addNodeAddress("redis://192.168.2.129:7000").addNodeAddress("redis://192.168.2.129:7001")
//                .addNodeAddress("redis://192.168.2.129:7002").addNodeAddress("redis://192.168.2.129:7003")
//                .addNodeAddress("redis://192.168.2.129:7004").addNodeAddress("redis://192.168.2.129:7005");
    ...
    public JedisPool jedisPool(JedisPoolConfig jedisPoolConfig){
        return new JedisPool(jedisPoolConfig,"192.168.2.129",6379);
    }
    ...
    public JedisConnectionFactory jedisConnectionFactory(JedisPoolConfig jedisPoolConfig){
        ...
        redisStandaloneConfiguration.setHostName("192.168.2.129");
